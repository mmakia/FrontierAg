...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3><%: Title %>.</h3>
        <p class="lead">Frontier Agrecultural Sciences website provide an internal ordering system and is still under construction, for testing purposes, the database have been seeded with sample data<br />
