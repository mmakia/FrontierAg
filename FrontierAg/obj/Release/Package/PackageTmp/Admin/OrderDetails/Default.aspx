...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="Div2" runat="server" class="ContentHead">
                <h3>Order Processing</h3>
            </div>

            <div id="OpenOrderTitle" runat="server" class="ContentHead">
                <h4>Order</h4>
            </div>
            ...
            <asp:GridView ID="OpenOrdersList2" runat="server" AutoGenerateColumns="False" ItemType="FrontierAg.Models.Order" DataKeyNames="OrderId" SelectMethod="OpenOrdersList_GetData" UpdateMethod="OpenOrders_UpdateItem"
                ...
                <Columns>
                    ...
                    <asp:DynamicField DataField="CreatedBy" HeaderText="Created By" ReadOnly="true" />
            ...
            <div id="Div1" runat="server" class="ContentHead">
                <h4>Shipping To (Editable for multiple shipments, When each shipment is going to a different address)</h4>
            </div>
            ...
            <div id="OperOrderTitle" runat="server" class="ContentHead">
                <h4>Products</h4>
            </div>
