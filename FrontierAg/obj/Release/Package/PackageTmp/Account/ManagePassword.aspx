<%@ Page Title="Manage Password" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManagePassword.aspx.cs" Inherits="FrontierAg.Account.ManagePassword" %>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <asp:Button runat="server" Text="Set Password" ValidationGroup="SetPassword" OnClick="SetPassword_Click" CssClass="btn btn-warning" />
                        </div>
                    </div>
                </div>
            </asp:PlaceHolder>
