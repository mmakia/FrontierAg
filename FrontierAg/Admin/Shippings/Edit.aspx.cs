...
namespace FrontierAg.Shippings
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        // This is the Update methd to update the selected Shipping item
        // USAGE: <asp:FormView UpdateMethod="UpdateItem">
        public void UpdateItem(int  ShippingId)
        {
            using (_db)
            {
        ...
        // This is the Select method to selects a single Shipping item with the id
