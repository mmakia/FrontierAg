...
namespace FrontierAg.OrderDetails
{
    public partial class Delete : System.Web.UI.Page
    {
        ...
        public FrontierAg.Models.OrderDetail GetItem([FriendlyUrlSegmentsAttribute(0)]int? OrderDetailId)
        {
            ...
            using (_db)
            {
	            return _db.OrderDetails.Where(m => m.OrderDetailId == OrderDetailId).FirstOrDefault();
            }
        }
