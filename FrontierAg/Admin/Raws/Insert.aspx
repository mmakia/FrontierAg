    ...
    <div class="table-responsive">
        <table class="table">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DDLSelectProduct" runat="server"
                        ...
                        SelectMethod="GetProducts" DataTextField="ProductNoName"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TXTBXManufacturerLot" runat="server" CssClass="form-control ExtendedWidth"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TXTBXDateReceived" runat="server" CssClass="form-control ExtendedWidth" ClientIDMode="Static"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="TXTBXExpirationDate" runat="server" CssClass="form-control ExtendedWidth" ClientIDMode="Static"></asp:TextBox>
