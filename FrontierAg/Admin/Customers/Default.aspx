<%@ Page Title="CustomerList" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Default.aspx.cs" Inherits="FrontierAg.Admin.Customers.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div>
        <asp:ListView id="ListView1" runat="server"
			...
			ItemType="FrontierAg.Models.Customer"
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>
								<asp:LinkButton Text="PPhone" CommandName="Sort" CommandArgument="PPhone" runat="Server" />
							</th>
                            <th>
								<asp:LinkButton Text="PPType" CommandName="Sort" CommandArgument="PPType" runat="Server" />
							</th>
                            <th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Admin/Customers/Details", Item.CustomerId) %>' Text="Details" /> | 
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Admin/Customers/Edit", Item.CustomerId) %>' Text="Edit" /> | 
                        <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Admin/Customers/Delete", Item.CustomerId) %>' Text="Delete" />
                    </td>
                </tr>
            </ItemTemplate>
        </asp:ListView>
