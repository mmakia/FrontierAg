                ...
                using (ProductContext db = new ProductContext())
                {
                    ...
                    if (OrderingToEmail != ShippingToEmail)
                    {
                        if (Session["EmailOrderingCustomer"].ToString() != "False")
                        {
                            ...
                            new Emailer().SendEmail(OrderingToEmail, "orders@frontierssi.com", "Frontier Agricultural Sciences Order #" + orderId, "<p style='color: #CC0000;'>Hello,</p>Thank you for shopping with us. You ordered item(s) below.<br /><br /><div style='color: #CC0000;'>Details:</div>" + messageBody + "<br />Feel free to contact us if you have any question.<br /> http://www.insectrearing.com/contact.html <br /><br /><br />Frontier Agricultural Sciences");
